							...
							<table class="table align-items-center mb-0">
								<thead>
									<tr>
										...
										<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">상품정보</th>
										...
										<tr>
											<td><div class="d-flex px-2 py-1">
													<div class="d-flex flex-column justify-content-center">
														<h6 class="mb-0 text-sm">${dto.board_bno }</h6>
													</div>
												</div>
											</td>
											<td>
											...
											<td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"></span></td>
											<td class="align-middle"><a href="saleDetail.jsp" class="text-secondary font-weight-bold text-xs"> </a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
