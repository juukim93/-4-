		...
		<div class="row">
			<div>
		          <div class="card mb-4">
		            <div class="card-header pb-0">
		              <h6>공지사항</h6>
					  <input type = "button" class="admin-delete" value="삭제" onclick="location.href='AnnouncementDelete.bo'">      
					  <input type = "button" class="admin-rewrite" value="수정" onclick="location.href='AnnouncementUpdate.bo'">
		              <input type = "button" class="admin-write" value="등록" onclick="location.href='AnnouncementWrite.bo'">
		            </div>
		            <div class="card-body px-0 pt-0 pb-2">
		              <div class="table-responsive p-0">
		                <table class="table align-items-center mb-0">
		                  <thead>
		                    <tr>
		                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2 th1">글번호</th>
						        ...
						        <tr>
						            ...
						            <td>
		                                <p class="text-xs font-weight-bold mb-0">
		                                	<a href="./AnnouncementContent.bo?board_bno=${dto.board_bno }&pageNum=${pageNum}&search=${param.search}">${dto.board_subject }</a>
		                                </p>
						            </td>
						            <td class="align-middle text-center text-sm">
		                                <p class="text-xs font-weight-bold mb-0">${dto.id }</p>
						            </td>
						            <td class="align-middle text-center">
						                <span class="text-secondary text-xs font-weight-bold">${dto.board_readcount }</span>
						            </td>
			...
			<div id="page_control">
				<c:if test="${startPage > pageBlock }">
					<a href="./Announcement.bo?pageNum=${startPage-pageBlock }&search=${param.search}">이전페이지</a>
				</c:if>
				...
				<c:if test="${endPage < pageCount }">
					<a href="./Announcement.bo?pageNum=${startPage+pageBlock }&search=${param.search}">다음페이지</a>
				</c:if>
			</div>
