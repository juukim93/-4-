 ...
 * Generated at: 2023-11-02 03:22:10 UTC
...
public final class main_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>폰 미쳤다!!</title>\r\n");
      out.write("    <link rel=\"stylesheet\" type=\"text/css\" href=\"css/reset.css\"/>\r\n");
      out.write("    <link rel=\"stylesheet\" type=\"text/css\" href=\"css/layout.css\"/>\r\n");
      out.write("    <link rel=\"stylesheet\" id=\"pagestyle\" href=\"css/board.css\"  />\r\n");
      ...
      out.write("                var setIntervalId;\r\n");
      out.write("                var $btns = $('.btns li');      // 슬라이드 버튼 변수 생성\r\n");
      out.write("                \r\n");
      out.write("                //초기값 첫번째 버튼으로 설정\r\n");
      out.write("                $btns.eq(0).addClass('active');\r\n");
      out.write("\r\n");
      out.write("                // 슬라이드 버튼 클릭 시 해당 페이지로 이동\r\n");
      out.write("                $('.btns li').click(function(){\r\n");
      out.write("                        var i = $(this).index();\r\n");
      out.write("                        move(i);\r\n");
      out.write("                        //console.log(i)\r\n");
      out.write("                        $btns.removeClass('active'); // 모든 버튼에서 'active' 클래스 제거\r\n");
      out.write("                         $(this).addClass('active'); // 클릭된 버튼에 'active' 클래스 추가\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("                $('.imgs').on({\r\n");
      out.write("                        // 슬라이드 마우스 오버 시 멈춤\r\n");
      out.write("                        mouseover:function(){\r\n");
      out.write("                            clearInterval(setIntervalId)\r\n");
      out.write("                        },\r\n");
      out.write("                        // 슬라이드 마우스 아웃 시 작동\r\n");
      out.write("                        mouseout:function(){\r\n");
      out.write("                            timer();  \r\n");
      out.write("                        }     \r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("                // 슬라이드 넘어가는 시간 함수\r\n");
      out.write("                timer();\r\n");
      out.write("                function timer(){\r\n");
      out.write("                    setIntervalId = setInterval(function(){\r\n");
      out.write("                    var n = current + 1;\r\n");
      out.write("                    if(n==4){\r\n");
      out.write("                    n=0; \r\n");
      out.write("                    }\r\n");
      out.write("                    move(n);  \r\n");
      ...
      out.write("                function move(i) {\r\n");
      out.write("                    if (current == i) return;\r\n");
      out.write("\r\n");
      out.write("                    // 현재 활성 버튼에서 클래스 제거\r\n");
      out.write("                    $btns.eq(current).removeClass('active');\r\n");
      out.write("\r\n");
      out.write("                    var currentEl = $('.imgs > li').eq(current);\r\n");
      out.write("                    var nextEl = $('.imgs > li').eq(i);\r\n");
      out.write("\r\n");
      out.write("                    currentEl.css({ left: \"0%\" }).animate({ left: \"-100%\" });\r\n");
      out.write("                    nextEl.css({ left: \"100%\" }).animate({ left: \"0%\" });\r\n");
      out.write("\r\n");
      out.write("                    current = i;\r\n");
      out.write("\r\n");
      out.write("                    // 새로운 활성 버튼에 클래스 추가\r\n");
      out.write("                    $btns.eq(current).addClass('active');\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("            });\r\n");
      out.write("            \r\n");
      ...
      out.write("                const homeButton = $('.mn_btn:first');\r\n");
      ...
      out.write("                    <li><img src=\"./img/배너1.png\"></li>\r\n");
      out.write("                    <li><img src=\"./img/배너2.png\"></li>\r\n");
      out.write("                    <li><img src=\"./img/배너3.png\"></li>\r\n");
      out.write("                    <li><img src=\"./img/배너4.png\"></li>\r\n");
      out.write("                </ul>\r\n");
      out.write("\r\n");
      out.write("                <!-- 메인이미지 버튼부분 -->\r\n");
      ...
      out.write("            \r\n");
      out.write("            <!-- 하단이미지 부분 -->\r\n");
      out.write("            <div class=\"footer_imgs\">\r\n");
      out.write("                <img src=\"./img/footer_top_content.png\">\r\n");
      out.write("            </div>\r\n");
      out.write("\r\n");
      out.write("        </div>\r\n");
      out.write("    \r\n");
