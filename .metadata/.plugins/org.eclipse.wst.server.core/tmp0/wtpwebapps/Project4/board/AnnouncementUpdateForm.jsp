...
<body>
	...
	<div id="wrap">
			...
			<div class="main_mn">
				...
				<div class="mn_box">
					<a href="./main.ma" class="mn_btn">
						...
						</div> <span class="clickable-span">HOME</span>
					</a>
				</div>
				<!-- 중고매입버튼 -->
				<div class="mn_box">
					<a href="./product/orderList.jsp" class="mn_btn">
						...
						</div> <span class="clickable-span">내 기기 구매/대여</span>
					</a>
				</div>
				<!-- 중고판매버튼 -->
				<div class="mn_box">
					<a href="./product/saleList.jsp" class="mn_btn">
						...
						</div> <span class="clickable-span">내 기기 판매</span>
					</a>
				</div>
				<!-- 기기대여버튼 -->
				<div class="mn_box">
					<a href="./center/center.jsp" class="mn_btn">
						...
						</div> <span class="clickable-span">A/S 센터</span>
					</a>
				</div>
				<!-- 포토후기버튼 -->
				<div class="mn_box">
					<a href="Review.bo" class="mn_btn">
						...
						</div> <span class="clickable-span">포토후기</span>
					</a>
				</div>
				...
				<div class="mn_center">
					...
					<div class="mn_box">
						<a href="Announcement.bo" class="mn_btn">
							...
							</div> <span class="clickable-span">공지사항</span>
						</a>
					</div>
					<!-- Q&A 부분 -->
					<div class="mn_box">
						<a href="QNA.bo" class="mn_btn">
							...
							</div> <span class="clickable-span">Q&A</span>
						</a>
					</div>
					<!-- 운영정책 부분 -->
					<div class="mn_box">
						<a href="OperatingPolicy.jsp" class="mn_btn">
							...
							</div> <span class="clickable-span">운영정책</span>
						</a>
					</div>
				</div>
			</div>
		...
		<!-- 마이페이지 -->
		<div class="mypage">
			<a href="./member/myPage.jsp"> <span class="mypage_bt_icon"><img src="./icon/마이페이지.png"></span>
			</a>
		</div>
		<!-- 로그인 -->
		<div class="login">
		...
		<div class="search">
			<form action="">
				<input type="text" name="search" size="15" placeholder="  검색" style="border: none; width: 150px; height: 30px; font-size: 17px; float: left; border-radius: 10px 0 0 10px"> <input type="submit" value="" class="btn_submit">
		</div>
					...
					<div class="two_third first" style="height: auto">
						<div class="col-lg-12">
							...
							<div class="two_third first">
								<form method=post action="./AnnouncementContent.bo" id="acc">
									<table class="table">
										<tr>
											<th width=20% class="text-right">관리자아이디</th>
										</tr>
										<tr>
										...
										<tr>
											<td width=80%>${dto.board_content }</td>
										</tr>

										<tr>
											<td colspan="2" class="text-center"><input type=button value="목록으로" class="button" id="center-app2" onclick="javascript:history.back()"></td>
										</tr>
									</table>
								</form>
								<input type="button" value="작성하기" id="center-app2" onclick="location.href='AnnouncementWrite.bo'"> <input type="button" value="수정하기" id="center-app2"  onclick=" location.href='./AnnouncementUpdate.bo?board_bno=${dto.board_bno}&pageNum=${pageNum }';"> <input type="button" value="삭제하기" id="center-app2">
							</div>
