		                ...
		                <table class="table align-items-center mb-0">
		                  <thead>
		                    <tr>
		                      ...
		                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">가격(할인가)</th>
		                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">일일대여비용</th>
		                  ...
		                  <tbody>
		                    ...
		                    <tr>
		                      ...
		                      <td>
		                        <p class="text-xs text-secondary mb-0" style="text-decoration: line-through;">2,218,700원</p>
		                        <p class="text-xs font-weight-bold mb-0">1,520,000원</p>
		                      </td>
		                      <td class="align-middle text-center text-sm">
		                        <span class="text-xs font-weight-bold mb-0">25,000원</span>
		                      </td>
		                      <td class="align-middle text-center">
		                        <span class="text-secondary text-xs font-weight-bold">스마트폰</span>
		                      </td>
		                      <td class="align-middle">
		                        <a href="orderDetail.jsp" class="text-secondary font-weight-bold text-xs" >
		                          보기
		                        </a>
		                      </td>
		                    </tr>
